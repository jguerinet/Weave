...
open class Weave {
    ...
    open fun parseHeaders(
        ...
        headers.forEachIndexed { index, s ->
            ...
            when {
                ...
                s.equals(platform.title, ignoreCase = true) -> platformColumn = index
            }
    ...
    open fun parseCsv(
        ...
        while (currentLine != null) {
            ...
            if (platformColumn != -1) {
                ...
                val platformValue = currentLine[platformColumn] as? String
                if (
    ...
    open fun writeString(
        ...
        if (string.isBlank() && platform != Platform.WEB && platform != Platform.REACT_NATIVE) {
    ...
    open fun writeConstantsTypeHeader(writer: PrintWriter, typeName: String, config: ConstantsConfig) {
        writer.apply {
            if (platform == Platform.WEB || platform == Platform.REACT_NATIVE || config.isTopLevelClassCreated) {
    ...
    open fun writeConstantsTypeFooter(writer: PrintWriter, isTopLevelClassCreated: Boolean, isLastType: Boolean) {
        writer.apply {
            if (platform == Platform.WEB || platform == Platform.REACT_NATIVE || isTopLevelClassCreated) {
                // Add spacing for web Constants or mobile Constants if the top level class is created
                print("    ")
            }
            print("}")
